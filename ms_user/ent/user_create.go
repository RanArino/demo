...
func (uc *UserCreate) SetNillableStorageUsedBytes(i *int64) *UserCreate {
	if i != nil {
		uc.SetStorageUsedBytes(*i)
	}
	return uc
}

// SetStorageQuotaBytes sets the "storage_quota_bytes" field.
func (uc *UserCreate) SetStorageQuotaBytes(i int64) *UserCreate {
	uc.mutation.SetStorageQuotaBytes(i)
	return uc
}

// SetNillableStorageQuotaBytes sets the "storage_quota_bytes" field if the given value is not nil.
func (uc *UserCreate) SetNillableStorageQuotaBytes(i *int64) *UserCreate {
	if i != nil {
		uc.SetStorageQuotaBytes(*i)
	}
	return uc
}
...
func (uc *UserCreate) SetPreferencesID(id uuid.UUID) *UserCreate {
...
func (uc *UserCreate) SetNillablePreferencesID(id *uuid.UUID) *UserCreate {
	if id != nil {
...
func (uc *UserCreate) SetPreferences(u *UserPreferences) *UserCreate {
...
func (uc *UserCreate) defaults() {
	...
	if _, ok := uc.mutation.StorageQuotaBytes(); !ok {
		v := user.DefaultStorageQuotaBytes
		uc.mutation.SetStorageQuotaBytes(v)
	}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.StorageQuotaBytes(); !ok {
		return &ValidationError{Name: "storage_quota_bytes", err: errors.New(`ent: missing required field "User.storage_quota_bytes"`)}
	}
	if _, ok := uc.mutation.Status(); !ok {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.StorageQuotaBytes(); ok {
