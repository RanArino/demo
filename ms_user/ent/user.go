...
func (e UserEdges) PreferencesOrErr() (*UserPreferences, error) {
	if e.Preferences != nil {
		return e.Preferences, nil
	} else if e.loadedTypes[0] {
		return nil, &NotFoundError{label: userpreferences.Label}
	}
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldClerkUserID, user.FieldEmail, user.FieldFullName, user.FieldUsername, user.FieldProfilePictureURL, user.FieldStatus:
...
func (u *User) QueryPreferences() *UserPreferencesQuery {
...
func (u *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", u.StorageQuotaBytes))
	builder.WriteString(", ")
