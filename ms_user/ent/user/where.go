...
func StorageQuotaBytes(v int64) predicate.User {
	return predicate.User(sql.FieldEQ(FieldStorageQuotaBytes, v))
}
...
func StorageUsedBytesEQ(v int64) predicate.User {
	return predicate.User(sql.FieldEQ(FieldStorageUsedBytes, v))
}

// StorageUsedBytesNEQ applies the NEQ predicate on the "storage_used_bytes" field.
func StorageUsedBytesNEQ(v int64) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldStorageUsedBytes, v))
}

// StorageUsedBytesIn applies the In predicate on the "storage_used_bytes" field.
func StorageUsedBytesIn(vs ...int64) predicate.User {
	return predicate.User(sql.FieldIn(FieldStorageUsedBytes, vs...))
}

// StorageUsedBytesNotIn applies the NotIn predicate on the "storage_used_bytes" field.
func StorageUsedBytesNotIn(vs ...int64) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldStorageUsedBytes, vs...))
}

// StorageUsedBytesGT applies the GT predicate on the "storage_used_bytes" field.
func StorageUsedBytesGT(v int64) predicate.User {
	return predicate.User(sql.FieldGT(FieldStorageUsedBytes, v))
}

// StorageUsedBytesGTE applies the GTE predicate on the "storage_used_bytes" field.
func StorageUsedBytesGTE(v int64) predicate.User {
	return predicate.User(sql.FieldGTE(FieldStorageUsedBytes, v))
}

// StorageUsedBytesLT applies the LT predicate on the "storage_used_bytes" field.
func StorageUsedBytesLT(v int64) predicate.User {
	return predicate.User(sql.FieldLT(FieldStorageUsedBytes, v))
}

// StorageUsedBytesLTE applies the LTE predicate on the "storage_used_bytes" field.
func StorageUsedBytesLTE(v int64) predicate.User {
	return predicate.User(sql.FieldLTE(FieldStorageUsedBytes, v))
}

// StorageQuotaBytesEQ applies the EQ predicate on the "storage_quota_bytes" field.
func StorageQuotaBytesEQ(v int64) predicate.User {
	return predicate.User(sql.FieldEQ(FieldStorageQuotaBytes, v))
}

// StorageQuotaBytesNEQ applies the NEQ predicate on the "storage_quota_bytes" field.
func StorageQuotaBytesNEQ(v int64) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldStorageQuotaBytes, v))
}

// StorageQuotaBytesIn applies the In predicate on the "storage_quota_bytes" field.
func StorageQuotaBytesIn(vs ...int64) predicate.User {
	return predicate.User(sql.FieldIn(FieldStorageQuotaBytes, vs...))
}

// StorageQuotaBytesNotIn applies the NotIn predicate on the "storage_quota_bytes" field.
func StorageQuotaBytesNotIn(vs ...int64) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldStorageQuotaBytes, vs...))
}

// StorageQuotaBytesGT applies the GT predicate on the "storage_quota_bytes" field.
func StorageQuotaBytesGT(v int64) predicate.User {
	return predicate.User(sql.FieldGT(FieldStorageQuotaBytes, v))
}

// StorageQuotaBytesGTE applies the GTE predicate on the "storage_quota_bytes" field.
func StorageQuotaBytesGTE(v int64) predicate.User {
	return predicate.User(sql.FieldGTE(FieldStorageQuotaBytes, v))
}

// StorageQuotaBytesLT applies the LT predicate on the "storage_quota_bytes" field.
func StorageQuotaBytesLT(v int64) predicate.User {
	return predicate.User(sql.FieldLT(FieldStorageQuotaBytes, v))
}

// StorageQuotaBytesLTE applies the LTE predicate on the "storage_quota_bytes" field.
func StorageQuotaBytesLTE(v int64) predicate.User {
	return predicate.User(sql.FieldLTE(FieldStorageQuotaBytes, v))
}
...
func HasPreferencesWith(preds ...predicate.UserPreferences) predicate.User {
	return predicate.User(func(s *sql.Selector) {
