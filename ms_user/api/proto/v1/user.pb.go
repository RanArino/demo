...
func (x *GetUserRequest) GetClerkUserId() string {
	if x != nil {
		if x, ok := x.Identifier.(*GetUserRequest_ClerkUserId); ok {
			return x.ClerkUserId
		}
	}
	return ""
...
type GetUserRequest_UserId struct {
	UserId string `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3,oneof"` // Internal user ID
}

type GetUserRequest_ClerkUserId struct {
	ClerkUserId string `protobuf:"bytes,2,opt,name=clerk_user_id,json=clerkUserId,proto3,oneof"` // Clerk user ID (for auth resolution)
}

func (*GetUserRequest_UserId) isGetUserRequest_Identifier() {}

func (*GetUserRequest_ClerkUserId) isGetUserRequest_Identifier() {}
...
const file_api_proto_v1_user_proto_rawDesc = "" +
	...
	"\x13ActivateUserRequest\x12\x1b\n" +
	...
	"\rclerk_user_id\x18\x02 \x01(\tH\x00R\vclerkUserIdB\f\n" +
	"\n" +
	"identifier\"4\n" +
	"\x0fGetUserResponse\x12!\n" +
	"\x04user\x18\x01 \x01(\v2\r.user.v1.UserR\x04user\"\xb8\x01\n" +
	"\x11UpdateUserRequest\x12\x19\n" +
	"\x05email\x18\x01 \x01(\tH\x00R\x05email\x88\x01\x01\x12 \n" +
	"\tfull_name\x18\x02 \x01(\tH\x01R\bfullName\x88\x01\x01\x12\x1f\n" +
	"\busername\x18\x03 \x01(\tH\x02R\busername\x88\x01\x01\x12\x17\n" +
	"\x04role\x18\x04 \x01(\tH\x03R\x04role\x88\x01\x01B\b\n" +
	"\x06_emailB\f\n" +
	"\n" +
	"_full_nameB\v\n" +
	"\t_usernameB\a\n" +
	...
	"\btimezone\x18\x03 \x01(\tH\x02R\btimezone\x88\x01\x01\x12E\n" +
	"\x0fcanvas_settings\x18\x04 \x01(\v2\x17.google.protobuf.StructH\x03R\x0ecanvasSettings\x88\x01\x01\x12Q\n" +
	"\x15notification_settings\x18\x05 \x01(\v2\x17.google.protobuf.StructH\x04R\x14notificationSettings\x88\x01\x01\x12S\n" +
	"\x16accessibility_settings\x18\x06 \x01(\v2\x17.google.protobuf.StructH\x05R\x15accessibilitySettings\x88\x01\x01B\b\n" +
	"\x06_themeB\v\n" +
	"\t_languageB\v\n" +
	"\t_timezoneB\x12\n" +
	...
	"\x04user\x18\x04 \x01(\v2\r.user.v1.UserR\x04user2\xab\x04\n" +
	"\vUserService\x12E\n" +
	"\n" +
	...
	"\x15UpdateUserPreferences\x12%.user.v1.UpdateUserPreferencesRequest\x1a&.user.v1.UpdateUserPreferencesResponse\x12K\n" +
	"\fActivateUser\x12\x1c.user.v1.ActivateUserRequest\x1a\x1d.user.v1.ActivateUserResponse\x12T\n" +
...
func file_api_proto_v1_user_proto_init() {
	...
	file_api_proto_v1_user_proto_msgTypes[6].OneofWrappers = []any{
		...
		(*GetUserRequest_ClerkUserId)(nil),
	}
	file_api_proto_v1_user_proto_msgTypes[8].OneofWrappers = []any{}
	file_api_proto_v1_user_proto_msgTypes[12].OneofWrappers = []any{}
	type x struct{}
